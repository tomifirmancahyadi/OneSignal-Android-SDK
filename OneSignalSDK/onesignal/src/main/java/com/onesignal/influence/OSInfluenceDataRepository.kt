...
class OSInfluenceDataRepository(private val preferences: OSSharedPreferences) {
    ...
    companion object {
        ...
        protected const val PREFS_OS_LAST_ATTRIBUTED_NOTIFICATION_OPEN = "PREFS_OS_LAST_ATTRIBUTED_NOTIFICATION_OPEN"
        protected const val PREFS_OS_LAST_NOTIFICATIONS_RECEIVED = "PREFS_OS_LAST_NOTIFICATIONS_RECEIVED"
        protected const val PREFS_OS_LAST_IAMS_RECEIVED = "PREFS_OS_LAST_IAMS_RECEIVED"
        // Outcomes Influence params
        protected const val PREFS_OS_NOTIFICATION_LIMIT = "PREFS_OS_NOTIFICATION_LIMIT"
        protected const val PREFS_OS_IAM_LIMIT = "PREFS_OS_IAM_LIMIT"
        protected const val PREFS_OS_NOTIFICATION_INDIRECT_ATTRIBUTION_WINDOW = "PREFS_OS_INDIRECT_ATTRIBUTION_WINDOW"
        protected const val PREFS_OS_IAM_INDIRECT_ATTRIBUTION_WINDOW = "PREFS_OS_IAM_INDIRECT_ATTRIBUTION_WINDOW"
        // Outcomes Influence enable params
        protected const val PREFS_OS_DIRECT_ENABLED = "PREFS_OS_DIRECT_ENABLED"
        protected const val PREFS_OS_INDIRECT_ENABLED = "PREFS_OS_INDIRECT_ENABLED"
        protected const val PREFS_OS_UNATTRIBUTED_ENABLED = "PREFS_OS_UNATTRIBUTED_ENABLED"
        // Outcomes Channel Influence types
        protected const val PREFS_OS_OUTCOMES_CURRENT_NOTIFICATION_INFLUENCE = "PREFS_OS_OUTCOMES_CURRENT_SESSION"
        protected const val PREFS_OS_OUTCOMES_CURRENT_IAM_INFLUENCE = "PREFS_OS_OUTCOMES_CURRENT_IAM_INFLUENCE"
    }
}